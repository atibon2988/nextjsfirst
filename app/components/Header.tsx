...
<div className="max-w-7xl mx-auto px-4 flex justify-between items-center gap-4">
  ...
  {/* 2. KHỐI CĂN PHẢI (TỪ TRÁI QUA PHẢI: TÌM KIẾM -> TRANG CHỦ -> DANH MỤC -> GIỚI THIỆU -> SÁNG TỐI) */}
  <div className="flex items-center gap-6 flex-1 justify-end">
    ...
    <div className="relative" ref={menuRef}>
      ...
      {isMenuOpen && (
        <div className="absolute right-0 mt-3 w-48 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-xl shadow-xl border border-white/10 py-2 z-50">
