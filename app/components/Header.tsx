      ...
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="p-2.5 rounded-full bg-slate-800 dark:bg-slate-800 text-yellow-400 dark:text-white border border-slate-700 dark:border-slate-700 transition-transform active:scale-90"
          >
            {theme === 'dark' ? (
